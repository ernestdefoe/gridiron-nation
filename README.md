...
### Homepage — Light Mode
![Homepage in light mode](docs/screenshots/homepage-light.png)

### Homepage — Dark Mode
![Homepage in dark mode](docs/screenshots/homepage-dark.png)

### Discussion Page — Light Mode
![Discussion page in light mode](docs/screenshots/discussion-light.png)

### Discussion Page — Dark Mode
![Discussion page in dark mode](docs/screenshots/discussion-dark.png)
